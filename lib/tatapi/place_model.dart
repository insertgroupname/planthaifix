...
class ShopPlace {
  ...
  double latitude;
  double longitude;
  ShopPlaceInformation shopPlaceInformation;
  Location location;
  Contact contact;
  String thumbnailUrl;
  List mobilePictureUrls;
  ...
  factory ShopPlace.fromJson(Map<String, dynamic> json) => ShopPlace._(
        placeId: json["place_id"],
        placeName: json["place_name"],
        latitude: json["latitude"],
        longitude: json["longitude"],
        shopPlaceInformation: json["place_information"],
...
class ShopPlaceInformation {
  String introduction;
  String detail;
  List shopTypes;

  ShopPlaceInformation._({
    this.introduction,
    this.detail,
    this.shopTypes,
  });

  factory ShopPlaceInformation.fromJson(
          Map<String, dynamic> shopInformationJson) =>
      ShopPlaceInformation._(
        introduction: shopInformationJson["introduction"],
        detail: shopInformationJson["detail"],
        shopTypes: shopInformationJson["shopTypes"],
      );
}
//Parse section
...
Future<List> parseShopPlace(String responseBody) async {
  final parsed = [jsonDecode(responseBody)["result"]];
  return parsed.map<ShopPlace>((e) => ShopPlace.fromJson(e)).toList();
}
